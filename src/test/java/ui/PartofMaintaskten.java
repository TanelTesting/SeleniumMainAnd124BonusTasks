...
public class PartofMaintaskten {
//katsetus! static boolean internalProject = true; 
	public static void main(String[] args) throws InterruptedException {
		...
		boolean maintaskStepthree = false;
		for (WebElement element : elements) { 
			if (element.isDisplayed()) {
				System.out.println("\"Global presence\" is shown on the page");  
				maintaskStepthree = true; 
				break; 
			} 
		}
		if (!maintaskStepthree) {
